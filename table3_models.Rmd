...
These models build out table 3 which presents the results for the primary and secondary outcomes utilizing informed priors with 1. normal distributions and 2. Cauchy distributions.We follow the advice of Racheal Meager and incorporate disagreement in the literature and use 6 standard deviations and a mean = 0
...
per_cap_consumption_Bayesmodel <-
  brm(formula = consumption_asinh | weights(samp_wgt) ~
     ...
     set_prior("normal(0,6)", class = "b", coef = "treat_GK"), 
     seed = 1272022,
     warmup = 1000,
     iter = 2000,
     thin = 1,
...
per_cap_consumption_Bayesmodel <-
  brm(formula = consumption_asinh | weights(samp_wgt) ~
     ...
     data = per_cap_consumption_data,
     family = gaussian("identity"),
     set_prior("cauchy(0,6)", class = "b", coef = "treat_GK"), 
     seed = 1272022,
     warmup = 1000,
     iter = 2000,
     thin = 1,
     ...
     #threads = 3,need to get cmdstanr package working here
     save_pars = save_pars(all = TRUE), # potentially allows for more post-processing functionality
     file = "informed_prior_outcomes\\per_cap_consumption_cauchy_Bayes")
```
...
mcmc_trace(per_cap_consumption_Bayesmodel, n_warmup = 0,
           pars = c("b_Intercept", "b_cost_deviation", "b_treat_any", 
                    ...
                    "b_Lvill_eligible_ratio", "sd_block__Intercept", 
                    "sd_vid__Intercept", "sigma"))
ggsave("table_3_diagnostics\\per_cap_consumption_cauchytrace.png", plot = last_plot(), width = 12, height = 5)
...
mcmc_dens(per_cap_consumption_Bayesmodel,
           pars = c("b_Intercept", "b_cost_deviation", "b_treat_any", 
                    ...
                    "b_Lvill_eligible_ratio", "sd_block__Intercept", 
                    "sd_vid__Intercept", "sigma"))
ggsave("table_3_diagnostics\\per_cap_consumption_cauchy_dens.png", plot = last_plot(), width = 12, height = 5)
...
mcmc_dens_overlay(per_cap_consumption_Bayesmodel,
           pars = c("b_Intercept", "b_cost_deviation", "b_treat_any", 
                    ...
                    "b_Lvill_eligible_ratio", "sd_block__Intercept", 
                    "sd_vid__Intercept", "sigma"))
ggsave("table_3_diagnostics\\per_cap_consumption_cauchy_overlay.png", plot = last_plot(), width = 12, height = 5)
...
mcmc_acf(per_cap_consumption_Bayesmodel,
           pars = c("b_Intercept", "b_cost_deviation", "b_treat_any", 
                    ...
                    "b_Lvill_eligible_ratio", "sd_block__Intercept", 
                    "sd_vid__Intercept", "sigma"))
ggsave("table_3_diagnostics\\per_cap_consumption_cauchy_acf.png", plot = last_plot(), width = 12, height = 5)
```
